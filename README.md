...
|      `crossOrigin`      |                                        `string` : `'anonymous'`                                         | Cross-Origin Resource Sharing. [MDN documents.](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/CORS) Possible values: `'anonymous', 'use-credentials'`.                                                                                                                                       |
...
You can use plain string instead of object as well. See [Cloudimage documents](https://docs.cloudimage.io/transformations/image-operations) for more examples.
...
You can use plain string instead of object as well. See [Cloudimage documents](https://docs.cloudimage.io/transformations/image-watermarking) for more examples.
...
You can use plain string instead of object as well. See [Cloudimage documents](https://docs.cloudimage.io/transformations/image-filters) for more examples.
